...
<br>
- 1주차는 타이틀 메뉴화면을 구현함과 동시에 스토리와 컨셉을 짤 것 입니다.
- 2주차는 스토리를 다듬으며 맵을 구현함과 맵 그래픽 작업을 할 것 입니다.
- 3주차는 플레이어의 구현과 플레이어의 그래픽, 동작, 탄쏘기 등을 구현함과 동시에 플레이어에 맞춰 적의 그래픽을 같이 작업할 것 입니다.
- 4주차는 적과 적의 핵심인 패턴구현 과 3주차의 플레이어, 적의 그래픽을 계속 다듬어갈 생각입니다. 그리고 부가적으로 필요한 오브젝트를 만들 것 입니다.
- 5주차는 미구현 된 3,4주차를 정리하며 구현하고 UI의 구현과 지금까지의 디자인에 맞추어 UI 그래픽 작업을 할 것 입니다.
- 6주차는 마지막 단계인 만큼 그래픽을 한번씩 더 손보고 5주차에 구현하는 것을 마무리한다음 사운드를 입히고 동영상제작을 하여 마무리 할것 입니다. 
